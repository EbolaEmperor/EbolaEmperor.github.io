...
题目链接：[4006. 管道连接  -  BZOJ](https://www.lydsy.com/JudgeOnline/problem.php?id=4006)

斯坦纳树变成了斯坦纳森林……

那还是先做出所有连通状态的斯坦纳树，然后把一些树合并成森林

具体地，我们记录一下合法的连通性，一开始只有包含且仅包含某个频道所有点的连通状态合法，然后将这些合法状态合并后得到其它合法状态，合法状态合并时，顺便更新答案
