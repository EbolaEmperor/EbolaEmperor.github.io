...
题目链接：[4695. 最假女选手  -  BZOJ](https://www.lydsy.com/JudgeOnline/problem.php?id=4695)

势能线段树的大板题啊，5.6K大代码，我居然1h内写好&调好了QAQ

维护：区间最大值、区间次大值、区间最大值的数量、区间最小值、区间次小值、区间最小值的数量、区间和、区间加标记

这些操作都是吉老师课件里的例题，找一下吉老师的Segment Tree Beats课件看看吧，真的很丧心病狂啊。一个pushdown就写45行啊QAQ
