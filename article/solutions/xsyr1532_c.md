...
![](http://www.ebola.pro/images/xsyr1532_c_1.png)

### 题解

对于每个空地，处理出有哪些炮台可能会打到它。发现对于每个空地，如果有解，则至多有两个炮台能打到它，并且打到它时的路径一定是垂直而不可能重合，否则两个炮台就会互相打到

于是问题就变成了，炮台有两种选择，然后有若干条限制，每条限制有三种可能的形式：“x1竖直/水平”、“x1不能竖直/水平”、“(x1竖直/水平)或(x2竖直/水平)”。典型的2-SAT模型

本题的代码长度都是预处理堆起来的，真正的2-SAT部分其实很少
